...
function birds_authorbox_add_post_content($content)
{
    ...
    { // If the page is not a WooCommerce one, let's do the trick!
        if ((is_single() && ($posts_checkbox == 'yes')) || (is_page() && ($pages_checkbox == 'yes') && !is_home() && !is_front_page()))
        {
            ...
            {
                $content.= '<img alt="author\'s avatar" class="birds_box_avatar" src="' . get_the_author_meta('image', get_query_var('author')) . '">';
            }
            else
            {
                $blank = plugin_dir_url(__FILE__) . 'img/blank.png';
                $content.= '<img alt="author\'s avatar" class="birds_box_avatar" src="' . $blank . '">';
            }
            ...
            {
                $content.= '<a class="social_icon" href="' . esc_url(get_the_author_meta('twitter_birds')) . '" target="_blank"><img alt="twitter" src="';
            ...
            {
                $content.= '<a class="social_icon" href="' . esc_url(get_the_author_meta('facebook_birds')) . '" target="_blank"><img alt="facebook" src="';
            ...
            {
                $content.= '<a class="social_icon" href="' . esc_url(get_the_author_meta('google_plus_birds')) . '" target="_blank"><img alt="google plus" src="';
            ...
            {
                $content.= '<a class="social_icon" href="' . esc_url(get_the_author_meta('linkedin_birds')) . '" target="_blank"><img alt="linkedin" src="';
            ...
            {
                $content.= '<a class="social_icon" href="' . esc_url(get_the_author_meta('flickr_birds')) . '" target="_blank"><img alt="flickr" src="';
            ...
            {
                $content.= '<a class="social_icon" href="' . esc_url(get_the_author_meta('youtube_birds')) . '" target="_blank"><img alt="youtube" src="';
            ...
            {
                $content.= '<a class="social_icon" href="' . esc_url(get_the_author_meta('instagram_birds')) . '" target="_blank"><img alt="instagram" src="';
            ...
            {
                $content.= '<a class="social_icon" href="' . esc_url(get_the_author_meta('pinterest_birds')) . '" target="_blank"><img alt="pinterest" src="';
            ...
            {
                $content.= '<a class="social_icon" href="' . esc_url(get_the_author_meta('github_birds')) . '" target="_blank"><img alt="github" src="';
            ...
            {
                $content.= '<a class="social_icon" href="' . esc_url(get_the_author_meta('dribbble_birds')) . '" target="_blank"><img alt="dribbble" src="';
