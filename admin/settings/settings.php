...
$icons_circle = '<img alt="Circle Icons" src="' . plugins_url() . '/birds-author-box/public/icons/circle/icons.png">' ;
$icons_line = '<img alt="Line Icons" src="' . plugins_url() . '/birds-author-box/public/icons/line/icons.png">' ;
$icons_volumetric = '<img alt="Volumetric Icons" src="' . plugins_url() . '/birds-author-box/public/icons/volumetric/icons.png">' ;
$icons_flat = '<img alt="Flat Icons" src="' . plugins_url() . '/birds-author-box/public/icons/flat/icons.png">' ;
$icons_subtle = '<img alt="Subtle Icons" src="' . plugins_url() . '/birds-author-box/public/icons/subtle/icons.png">' ;
